...
${nuget_cmd} install src/Voicify.Sdk.Assistant/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Voicify.Sdk.Assistant.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Voicify.Sdk.Assistant.dll \
-recurse:'src/Voicify.Sdk.Assistant/*.cs' \
-doc:bin/Voicify.Sdk.Assistant.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Voicify.Sdk.Assistant.dll was created successfully"
fi
